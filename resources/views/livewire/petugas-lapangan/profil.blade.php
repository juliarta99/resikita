<div class="space-y-5">
    ...
    <div class="rounded-xl border border-slate-200 bg-white p-5">
        <div class="flex items-center gap-4">
            ...
            @endphp
            <div class="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-600 text-xl font-bold text-white">
                {{ strtoupper($inisial ?: '?') }}
            </div>
            <div class="min-w-0">
    ...
    <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <form wire:submit="ubahPassword" class="space-y-4">
                ...
                <button type="submit"
                    class="rounded-lg border border-emerald-600 bg-emerald-50 px-5 py-2.5 text-sm font-semibold text-emerald-700 hover:bg-emerald-100">
