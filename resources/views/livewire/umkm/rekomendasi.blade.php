    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="flex items-start justify-between gap-4">
            ...
            <div class="flex flex-none gap-2">
                @if ($rekomendasi)<button wire:click="exportRekomendasi" class="rounded-lg border border-gray-300 px-3 py-2 text-sm font-medium text-primary-900 hover:bg-gray-50">Export</button>@endif
                <button wire:click="generateAi" wire:loading.attr="disabled" wire:target="generateAi" class="rounded-lg border border-primary-500 px-4 py-2 text-sm font-semibold text-primary-600 hover:bg-primary-50 disabled:opacity-60">
