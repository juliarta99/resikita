<div class="mx-auto max-w-xl space-y-6">
    ...
    <form wire:submit="simpan" class="space-y-4 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div>
            ...
            <input wire:model="phone" class="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-primary-900 outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500">
        </div>
        <div>
            <label class="block text-sm font-medium text-primary-900">Kata sandi baru <span class="font-normal text-gray-400">(kosongkan jika tidak diubah)</span></label>
