<div class="mx-auto max-w-xl space-y-6">
    ...
    <form wire:submit="simpan" class="space-y-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
        ...
        <div class="pt-1 h-max"><button type="submit" class="w-full rounded-lg bg-primary-500 px-6 py-2.5 text-sm font-semibold text-white hover:bg-primary-700 sm:w-auto sm:float-right">Simpan</button></div>
    </form>
</div>