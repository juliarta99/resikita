<div class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        @if ($isAdmin)
            <button wire:click="export" class="w-full flex-none rounded-lg border border-primary-500 px-4 py-2 text-sm font-semibold text-primary-600 hover:bg-primary-50 sm:w-auto">
                Export Excel
            </button>
        @endif
    </div>
