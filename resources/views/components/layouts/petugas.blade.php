...
@php
    ...
    $tabs = [
        ['route' => 'petugas.dashboard', 'label' => 'Dashboard', 'bottomLabel' => 'Beranda',
        ...
        ['route' => 'petugas.tugas', 'label' => 'Tugas Saya', 'bottomLabel' => 'Tugas',
         'active' => request()->routeIs('petugas.tugas') || request()->routeIs('petugas.tugas.detail'),
        ...
        ['route' => 'petugas.peta', 'label' => 'Peta Sebaran', 'bottomLabel' => 'Peta',
         'active' => request()->routeIs('petugas.peta'),
        ...
        ['route' => 'petugas.profil', 'label' => 'Profil', 'bottomLabel' => 'Profil',
         'active' => request()->routeIs('petugas.profil'),
...
<div class="min-h-full">
            ...
            <div class="mx-auto flex max-w-5xl gap-1 overflow-x-auto px-4">
                ...
                @foreach ($tabs as $t)
                    <a href="{{ route($t['route']) }}"
                       class="{{ $tab }} {{ $t['active'] ? 'border-primary-500 text-primary-700' : 'border-transparent text-gray-500 hover:text-primary-900' }}">{{ $t['label'] }}</a>
                @endforeach
            </div>
        </nav>
    </header>
    ...
    <nav class="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-white md:hidden">
        <div class="mx-auto grid max-w-5xl grid-cols-4">
            @foreach ($tabs as $t)
                <a href="{{ route($t['route']) }}"
                   class="flex flex-col items-center gap-1 py-2.5 text-[11px] font-medium {{ $t['active'] ? 'text-primary-700' : 'text-gray-500' }}">
