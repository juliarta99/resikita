...
<head>
    ...
    <title>{{ $title ?? 'Dinas' }} — Niti Resik</title>
...
@php
    ...
    $tabs = [
        ...
        ['route' => 'dinas.laporan', 'label' => 'Laporan', 'match' => 'dinas.laporan',
        ...
        ['route' => 'dinas.profil', 'label' => 'Profil', 'match' => 'dinas.profil',
    ...
    <header class="fixed inset-x-0 top-0 z-40 border-b border-gray-200 bg-white/90 backdrop-blur">
        <div class="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    <p class="text-sm font-semibold leading-tight text-primary-900">Niti Resik | Dinas</p>
                    <p class="text-xs text-gray-500 leading-tight">Pengelolaan Laporan Sampah</p>
                </div>
            </div>
    ...
    <nav class="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-white md:hidden">
        <div class="mx-auto flex max-w-6xl items-stretch">
            @foreach ($tabs as $t)
                ...
                <a href="{{ route($t['route']) }}"
                   class="flex flex-1 flex-col items-center gap-1 py-2 text-[11px] font-medium {{ $active ? 'text-primary-700' : 'text-gray-500' }}">
